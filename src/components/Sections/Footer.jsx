...
export default function Footer() {
  ...
  return (
    ...
    <footer
      ...
      className="overflow-hidden h-[600px] flex flex-col justify-center w-full z-0"
      onMouseMove={handleMousemove}
      onMouseLeave={() => nudgeX.set(0)}
      ref={container}
    >
      <motion.div className="max-w-7xl mx-auto" style={{ opacity, translateY }}>
        ...
        <h1
          ...
          className="cursor-pointer font-serif text-[30px] md:text-[60px] lg:text-[110px] z-20 text-center leading-[.8] text-white font-extralight "
        >
          connorrothschild.com
        </h1>
        <div className="text-lg flex justify-end gap-2 items-center w-full text-gray-200 font-light text-center max-w-[300px] ml-auto mt-6">
          <FooterSocialLink
            label="X"
