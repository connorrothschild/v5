...
export default function ImageGrid() {
  ...
  return (
    <section className="px-[20px]">
      <motion.div
        className="grid sm:grid-cols-4 md:grid-rows-2 gap-2 max-w-7xl w-full max-h-[700px] mx-auto relative z-10"
        ref={ref}
        variants={container}
        initial="hidden"
        whileInView="visible"
        ...
        {images.map((image, index) => (
          ...
          >
            ...
            <div className="absolute p-4 top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-black opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end">
              <p className="text-white text-lg font-serif tracking-wide italic font-light">
                Praxis{" "}
              </p>
