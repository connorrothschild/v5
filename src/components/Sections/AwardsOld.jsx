      ...
      >
        <div
          ...
          style={{
            ...
            background: `radial-gradient(circle farthest-side at var(--x, 100px) var(--y, 100px), var(--shadow-color, #c28800) 0%, transparent ${shadowSize.get()}%)`,
        ...
        <section className="flex p-8 h-screen flex-col justify-center items-center">
          ...
          {/* Rotating carousel of awards. Hovering stops */}
          <div
            className="absolute bottom-0 left-0 h-[200px] cursor-none overflow-hidden flex flex-row group"
            onMouseOver={() => shadowSize.set(10)}
            onMouseLeave={() => shadowSize.set(40)}
          >
            <div className="flex flex-row justify-center items-center animate-marquee group-hover:pause">
