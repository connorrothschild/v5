...
Our ancestors didn’t have this luxury. For much of human history, survival and progress required making significant decisions. These weren’t decisions about whether or not to move cities or switch careers; they were decisions about whether to start a family, take a new job, or migrate to a new land. Those decisions were tied to the basic needs of life—**the need to survive and thrive**. Our grandparents, and many of our parents, lived in a time when making bold decisions about work, family, and property was the only way to build a life. Many of the decisions we now perceive as risky—buying a home, changing careers, or starting a business—were simply the next step in securing a future. 
